...
* [google/starlark-rust](https://github.com/google/starlark-rust) — An implementation of the Starlark language, a non-Turing complete language based on Python that was made for the Bazel build system.
